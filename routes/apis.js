...
router.get('/matchByHero',function(req,res){
	var _res = res;
...
router.post('/matchbyid',function(req,res){
	var _res = res;
...
router.post('/listofaccount',function(req,res){
	var _res = res;
...
router.get('/heroes_db',function(req,res){
...
router.get('/items_db',function(req,res){
...
router.get('/abilities_db',function(req,res){
